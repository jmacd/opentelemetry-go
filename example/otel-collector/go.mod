...
require (
	...
	go.opentelemetry.io/contrib/samplers/probability/consistent v0.5.2 // indirect
...
replace go.opentelemetry.io/contrib/samplers/probability/consistent => ../../../go-contrib/samplers/probability/consistent